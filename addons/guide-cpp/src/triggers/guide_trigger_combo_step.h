#ifndef GUIDE_TRIGGER_COMBO_STEP_H
#define GUIDE_TRIGGER_COMBO_STEP_H
...
public:
    ...
    double get_time_to_actuate() const { return time_to_actuate; }
    void set_time_to_actuate(double p_time) { time_to_actuate = p_time; emit_changed(); }

protected:
    static void _bind_methods();
};

#endif // GUIDE_TRIGGER_COMBO_STEP_H
