...
void GUIDEVirtualStick::_bind_methods() {
...
GUIDEVirtualStick::GUIDEVirtualStick() {
}

GUIDEVirtualStick::~GUIDEVirtualStick() {
}

void GUIDEVirtualStick::_ready() {
...
void GUIDEVirtualStick::_handle_mouse_input(const Ref<InputEventMouse> &event) {
    if (!_is_actuated) {
...
void GUIDEVirtualStick::_handle_touch_input(const Ref<InputEvent> &event) {
    if (!_is_actuated) {
...
void GUIDEVirtualStick::_try_actuate(Vector2 world_position) {
...
void GUIDEVirtualStick::_move_towards(Vector2 world_position) {
...
void GUIDEVirtualStick::_release() {
    _is_actuated = false;
...
void GUIDEVirtualStick::_report_input() {
...
void GUIDEVirtualStick::_send_event(int axis, float value) {
